        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 md:mt-12">
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src="https://www.wmsp.co.uk/fileadmin/_processed_/5/7/csm_photo-minibus2-600px_3f8bd75a8f.jpg" alt="Headless UI" class="w-full h-64 md:h-80 lg:h-96 object-cover">
                    <div class="p-4 md:p-6 lg:p-8">
                        <h3 class="text-xl md:text-2xl lg:text-3xl font-semibold text-primary mb-2">Book A Guided Tour</h3>
                        <p class="text-black mb-4 two-lines md:mb-6 lg:mb-8">
                            Completely unstyled, fully accessible UI components, designed to integrate beautifully with Tailwind CSS.
                        </p>
                        <a href="#" class="inline-block bg-primary hover:bg-primary-200 text-white px-4 py-2 rounded-full">Learn More</a>
                    </div>
                </div>

                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src="https://www.wmsp.co.uk/fileadmin/user_upload/west_midland_safari_park/attractions/elephant-04.jpg" alt="Heroicons" class="w-full h-64 md:h-80 lg:h-96 object-cover">
                    <div class="p-4 md:p-6 lg:p-8">
                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <img src="{{ asset('images/loyalty-program-img-3.jpeg') }}" alt="Hero Patterns" class="w-full h-64 md:h-80 lg:h-96 object-cover">
                    <div class="p-4 md:p-6 lg:p-8">
