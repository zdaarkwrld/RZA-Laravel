            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4 relative">
                <div class="bg-primary rounded-lg p-8 text-center md:w-1/3">
                    ...
                    <p class="text-xl font-light italic text-secondary">We had an amazing day at the zoo! The
                        exhibits
                        were well-designed and allowed us to get up close and personal with the animals. The gorilla
                        exhibit was our favorite – we could have spent hours watching their fascinating behavior.
                        Highly
                        recommend this zoo for a fun and educational family outing.!</p>
                ...
                <div class="bg-primary rounded-lg p-8 text-center md:w-1/3">
                    ...
                    <p class="text-xl font-light italic text-secondary">This zoo is a must-visit for anyone who
                        loves
                        animals! The staff was incredibly knowledgeable and passionate about the animals they care
                        for.
                        We attended a couple of the keeper talks, which were both informative and entertaining. The
                        zoo
                        grounds are beautifully maintained, and there are plenty of shaded areas to take a break.
                        We'll
                ...
                <div class="bg-primary rounded-lg p-8 text-center md:w-1/3">
                    ...
                    <p class="text-xl font-light italic text-secondary">We had a fantastic time at the zoo! The
                        petting
                        zoo was a hit with our little ones, and they loved getting up close and personal with the
                        friendly goats and sheep. The carousel and train rides were also a lot of fun. The zoo did a
                        great job of catering to families with young children while still providing an excellent
