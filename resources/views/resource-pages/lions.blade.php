<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="col-span-1 flex justify-end">
                <img src="https://t4.ftcdn.net/jpg/02/28/74/03/360_F_228740321_GOqRH2S8swb7aUgBbV2slahcsNwRQHUW.jpg"
                    alt="Sumatran Tiger" class="h-96 object-cover rounded-lg shadow-lg mr-8" />
                <!-- Updated class here -->
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div class="md:flex md:flex-col md:justify-center">
            <div class="h-96 w-full md:w-auto">
                <img src="https://images.musement.com/cover/0161/64/thumb_16063601_cover_header.jpg?w=540"
                    alt="Sumatran Tiger" class="h-full w-full rounded-lg shadow-lg object-cover" />
            </div>
        </div>
        <div>
            <p class="text-gray-700 mb-4 text-xl">
                According to a survey from "TRAFFIC", the global wildlife trade monitoring network, poaching for <br> skins
                is responsible for over 70% of all reported Sumatran tiger deaths, amounting to at least <br> 40 animals per
                year.
            </p>
            <p class="text-gray-700 text-xl">
                Key to helping protect Sumatran tigers and a critical part of Battersea's conservation system, are <br>the
                working together to help protect the species, we can protect the habitats from human <br>disturbance such as
                deforestation, which is currently resulting in serious loss of wild habitat and <br>prey species for wild
                Sumatran tigers.
            </p>
        </div>
    </div>
