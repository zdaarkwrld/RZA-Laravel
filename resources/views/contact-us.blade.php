<x-app-layout>
    ...
    <!-- Main container -->
    <div class="max-w-screen-lg mx-auto p-4 mt-14 mb-10 shadow-2xl shadow-primary-200 rounded-3xl">
        <!-- Grid container -->
        <div class="grid grid-cols-1 md:grid-cols-12 border rounded-3xl">


            <!-- Contact information -->
            <div class="bg-primary md:col-span-4 py-12 px-9 border shadow-2xl text-white mb-8 rounded-3xl ">
                <!-- Contact title -->
                ...
                <div class="flex items-center mt-5">
                    <svg class="h-6 mr-2 text-secondary" fill="currentColor" version="1.1"
